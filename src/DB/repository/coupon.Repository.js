...
let CouponRepository = class CouponRepository extends DB_repository_1.repository {
    _CouponModel;
    constructor(_CouponModel) {
        super(_CouponModel);
...
exports.CouponRepository = CouponRepository = __decorate([
    __param(0, (0, mongoose_1.InjectModel)(index_1.Coupon.name)),
