...
let BrandRepository = class BrandRepository extends DB_repository_1.repository {
    _BrandModel;
    constructor(_BrandModel) {
        super(_BrandModel);
...
exports.BrandRepository = BrandRepository = __decorate([
    __param(0, (0, mongoose_1.InjectModel)(index_1.Brand.name)),
